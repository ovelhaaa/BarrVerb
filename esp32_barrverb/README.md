...
*   `+`: Next Program
*   `-`: Previous Program
*   `s`: Cycle Signal Source (Silence -> Impulse -> Sawtooth -> Sine)

### Audio Output

Connect the output of your I2S DAC to an amplifier or headphones. You should hear the test signal processed by the reverb.
*   **Impulse**: Useful for hearing the reverb tail clearly.
*   **Saw/Sine**: Useful for testing signal integrity.
